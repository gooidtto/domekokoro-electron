...
const precision = process.platform === 'darwin' ? 'fp16' : 'int8';
...
const files = [
  [`kokoro-v1.1-zh.${precision}.onnx`, `kokoro-v1.1-zh.${precision}.onnx`],
  ['voices-v1.1-zh.bin', 'voices-v1.1-zh.bin'],
];
